...
const companies = [
  ...
  },
  {
    ...
    nameRussian:
      "Форум по интердисциплинарным исследованиям в медицинской науке и технологиях (FIRMST)",
    infoRussian:
      "FIRMST - это инициатива, направленная на поощрение и поддержку инновационных идей в молодых умах. Тем самым мы сокращаем разрыв между профессионалами и экспертами различных медицинских специальностей и смежных науках.",
  },
  {
    id: 3,
    name: "Eurasian Cancer Research Council (ECRC)",
    website: "https://www.ecrc.pro",
    ...
    infoRussian:
      "Евразийский совет по исследованию рака (ECRC) - НЕКОММЕРЧЕСКАЯ организация, специализирующаяся на проведении и продвижении кооперированных исследований в онкологии по всему миру",
  },
  {
    id: 4,
    name: "Eurasian Society of Head and Neck Oncology (EASHNO)",
    website: "https://www.eashno.org",
    ...
    infoRussian:
      "Евразийское общество онкологов головы и шеи (EASHNO) - автономная профессиональная организация, объединяющая группу специалистов по онкологии головы и шеи из разных стран.",
  },
  {
    id: 5,
    name: "PathoLogica Service",
    website: "https://www.pathologica.ru",
    logo: "https://static.wixstatic.com/media/df6cc5_281194d6b7f847c28a237bc6e58dedee~mv2.png",
    info: "Eurasian Cancer Research Council (ECRC) is a NOT-FOR-PROFIT organisation specializing in conducting and promoting collaborative Cancer Research beyond borders across continents.",
    nameRussian: "PathoLogica Service",
    infoRussian:
      "PathoLogica Service — это общественно направленный проект, созданный с целью повышения доступности качественной диагностики онкологических заболеваний в России и странах СНГ. Эксперты PathoLogica Service выполняют исследования на современном оборудовании и коллегиально устанавливают диагноз в самых сложных случаях.",
  },
  {
    id: 6,
    ...
    infoRussian:
      "Деятельность фонда направлена на изменение ситуации в области борьбы с раковыми заболеваниями в России и повышение доступности квалифицированной помощи онкологическим пациентам. Фонд собрал команду высококвалифицированных специалистов – практикующих врачей-онкологов.",
  },
  {
    id: 7,
    ...
    infoRussian:
      "Фонд Ремесло добра - некоммерческая организация, которая занимается приютом для людей в трудной жизненной ситуации. Задачей фонда является социальная адаптация безработных и бездомных подопечных благотворительных фондов и социальных государственных учреждений Москвы и Московской области.",
  },
  {
    id: 8,
    name: "FIRMST Study Abroad",
    website: "https://sa.firmst.tech",
  ...
  },
  {
    ...
    nameRussian: "PASOVIT",
    infoRussian:
      "Мы работаем вместе, создавая высококачественное программное обеспечение по индивидуальному запросу. В нашу команду входят консультанты, дизайнеры продуктов, разработчики программного обеспечения, тестировщики контроля качества, менеджеры по продуктам и продакт-оунеры.",
  },
  {
    id: 10,
    name: "Health-Direct",
    website: "https://www.health-direct.info",
    logo: "https://static.wixstatic.com/media/df6cc5_0bd45e5e12f043ef90f0a4ca376849b4~mv2.png",
    ...
    infoRussian:
      "Health-Direct возглавляют ведущие хирурги в области онкогинекологии, онкологии головы и шеи, лечения опухолей кожи и меланомы. Мы берем на себя заботы по подбору первоклассных хирургов, согласованию лекарственной (химиотерапия, гормонотерапия, таргетная терапия, иммунотерапия) или лучевой терапии и оперативному проведению дообследований. ",
  },
];
